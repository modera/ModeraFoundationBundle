...
interface AdaptableInterface
{
     ...
     * @param mixed[] $data    Some optional data that may be used by the method when creating the adapter
     *
     * @return object|null If adapter of type $adapter cannot be created then NULL is returned
     */
    public function getAdapter(string $adapter, array $data = []): ?object;
}
